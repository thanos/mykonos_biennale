defmodule MykonosBiennaleWeb.Admin.ArtLive do
  use Backpex.LiveResource,
    adapter_config: [
      schema: MykonosBiennale.Data.Art,
      repo: MykonosBiennale.Repo,
      update_changeset: &MykonosBiennale.Data.Art.changeset/3,
      create_changeset: &MykonosBiennale.Data.Art.changeset/3,
  ...
  def item_query(query, :index, _assigns) do
    query
    |> where([_entity], fragment("fields->>'type' = 'art'"))
  end

  def item_query(query, _live_action, _assigns), do: query

  @impl Backpex.LiveResource
  def singular_name, do: "Art"

  @impl Backpex.LiveResource
  def plural_name, do: "Art"
