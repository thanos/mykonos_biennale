defmodule MykonosBiennaleWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use MykonosBiennaleWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    ...
    scope = MykonosBiennale.Accounts.Scope.for_user(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    MykonosBiennale.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
